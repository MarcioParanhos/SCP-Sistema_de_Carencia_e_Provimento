    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                ...
                <h6 class="user_auth font-weight-normal mb-0"><span class="text-primary subheader">{{ Auth::user()->name }} | {{ Auth::user()->setor }} </span></h6>
            </div>
        ...
        <div  class="card p-4 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-around" style="border-top: 2px solid #fbf8f3;">
                                <div class="mt-2 d-flex flex-column justify-content-center align-middle">
                                    ...
                                    <p class="font_sub-title">{{ number_format($carenciasBasicaReal, 0, ',', '.') }} h</p>
                                </div>
                                <div class="mt-2 d-flex flex-column  justify-content-center align-middle">
                                    <p class="text-center subheader">PROFISS.</p>
                                    <p class="text-center font_sub-title">{{ number_format($carenciasProfiReal, 0, ',', '.') }} h</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-dark-blue">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-around" style="border-top: 2px solid #fbf8f3;">
                                <div class="mt-2 d-flex flex-column justify-content-center align-middle">
                                    <p class="text-center subheader">BÁSICA</p>
                                    <p class="text-center font_sub-title" style="font-size: 22px;">{{ number_format($carenciasBasicaTemp, 0, ',', '.') }} h</p>
                                </div>
                                <div class="mt-2 d-flex flex-column  justify-content-center align-middle">
                                    <p class="text-center subheader">PROFISS.</p>
                                    <p class="text-center font_sub-title" style="font-size: 22px;">{{ number_format($carenciasProfiTemp, 0, ',', '.') }} h</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-around" style="border-top: 2px solid #fbf8f3;">
                                <div class="mt-2 d-flex flex-column justify-content-center align-middle">
                                    ...
                                    <p class="text-center font_sub-title" style="font-size: 22px;">{{ number_format($carenciasRealEdEspecial, 0, ',', '.') }} h</p>
                                </div>
                                <div class="mt-2 d-flex flex-column  justify-content-center align-middle">
            ...
            <div class="mb-2 row gap_mobile">
                <div class="col-md-6 mb-2 stretch-card transparent">
                    <div class="card card-dark-blue">
                        <div class="card-body">
                            <p class="text-center font_title mb-2 subheader"><strong>TOTAL DE PROVIMENTO - {{ number_format($provimentosReal+$provimentosTemp, 0, ',', '.') }} h</strong></p>
                            <div class="d-flex justify-content-around" style="border-top: 2px solid #fbf8f3;">
                                <div class="mt-2 d-flex flex-column justify-content-center align-middle">
                                    <p class="text-center subheader">REAL</p>
                                    <p class="font_sub-title" style="font-size: 22px;">{{ number_format($provimentosReal, 0, ',', '.') }} h</p>
                                </div>
                                <div class="mt-2 d-flex flex-column  justify-content-center align-middle">
                                    <p class="text-center subheader">TEMP.</p>
                                    <p class="font_sub-title fs-30" style="font-size: 22px;">{{ number_format($provimentosTemp, 0, ',', '.') }} h</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 mb-2 stretch-card transparent">
                    <div class="card card-dark-blue">
                        <div class="card-body">
                            <p class="text-center font_title mb-2 subheader"><strong>PROV. EM TRÂMITE - {{ number_format($provimentosTramiteReal+$provimentosTramiteTemp, 0, ',', '.') }} h</strong></p>
                            <div class="d-flex justify-content-around" style="border-top: 2px solid #fbf8f3;">
                                <div class="mt-2 d-flex flex-column justify-content-center align-middle">
                                    <p class="text-center subheader">REAL</p>
                                    <p class="font_sub-title" style="font-size: 22px;">{{ number_format($provimentosTramiteReal, 0, ',', '.') }} h</p>
                                </div>
                                <div class="mt-2 d-flex flex-column  justify-content-center align-middle">
                                    <p class="text-center subheader">TEMP.</p>
                                    <p class="font_sub-title fs-30" style="font-size: 22px;">{{ number_format($provimentosTramiteTemp, 0, ',', '.') }} h</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                    <div class="ml-xl-4 mt-3">
                                        ...
                                        <p class="mb-2 mb-xl-0">Top 5 disciplinas com maior quantidade de carência lançada no sistema do SCP</p>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="w-100 px-0">
                                                            <div class="progress progress-md mx-4">
                                                                <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $new_total }}%" aria-valuenow="{{ $disciplina->total }}" aria-valuemin="0" aria-valuemax="{{ $totalCarencia }}">
                                                                </div>
                                                        </td>
                                                        <td>
                                                            <h5 class="font-weight-bold mb-0">{{ $disciplina->total }} h</h5>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                    <div class="ml-xl-4 mt-3">
                                        ...
                                        <p class="mb-2 mb-xl-0">Top 5 Unidades Escolares com maior quantidade de carência lançada no sistema do SCP</p>
                                    </div>
                                </div>
                                <div class="col-md-12 col-xl-9">
                                    <div class="row">
                                            ...
                                            <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                <table class="table table-borderless report-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($uee->nte >= 10)
                                                        <td class="text-muted subheader">NTE {{ $uee->nte }} - {{ $uee->municipio }} - {{ $uee->unidade_escolar }} - {{ $uee->cod_ue }} </td>
                                                        @endif
                                                        @if ($uee->nte < 10) <td class="text-muted">NTE 0{{ $uee->nte }} - {{ $uee->municipio }} - {{ $uee->unidade_escolar }} - {{ $uee->cod_ue }} </td>
                                                            @endif
                                                            <td>
                                                            ...
                                                            <td class="w-100 px-0">
                                                                <div class="progress progress-md mx-4">
                                                                    <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $new_totalUEE }}%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <h5 class="font-weight-bold mb-0">{{ $uee->total }}h</h5>
                                                            </td>
                                                    </tr>
                                                    @endforeach
