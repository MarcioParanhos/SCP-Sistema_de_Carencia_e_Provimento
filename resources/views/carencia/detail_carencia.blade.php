    ...
    <div class="card">
            ...
            @if (session('ref_rota') != 'provimento')
                <div class="print-none d-flex justify-content-center align-items-center print-none">
                    <a data-toggle="tooltip" data-placement="top" title="Voltar" class="m-1 btn bg-white text-primary"
                        href="/carencias/filter_carencias">
            ...
            <div class="edit-container-homlogada">
                <div class="user-edit">
                    @if ($carencia->tipo_carencia === 'Real')
                        <h5 class="text-white badge badge-info"><b>VAGA REAL</b></h5>
                    @endif
                    @if ($carencia->tipo_carencia === 'Temp')
                        <h5 class="text-white badge badge-info"><b>VAGA TEMPORARIA</b></h5>
                    @endif
                    @if ($detailUeeHomologacao->situacao === 'PENDENTE')
                        <h5 class="badge badge-danger"><b>UEE PENDENTE HOMOLOGAÇÃO</b></h5>
                    @endif
                    @if ($detailUeeHomologacao->situacao === 'HOMOLOGADA')
                        <h5 class="badge badge-success"><b>UEE HOMOLOGADA</b></h5>
                    @endif
                </div>
            </div>
        ...
        <div class="shadow card_info">
            <form class="mb-3" action="/carencias/update/{{ $carencia->id }}" method="post">
                ...
                <input value="{{ $carencia->id }}" id="carencia_id" name="carencia_id" type="text"
                    class="form-control form-control-sm" hidden>
                <div class="form-row">
                    @if ($carencia->nte < 10)
                        <div class="col-md-1">
                            <div class="form-group_disciplina">
                                ...
                                <input value="0{{ $carencia->nte }}" name="nte" id="nte" type="text"
                    ...
                    @if ($carencia->nte > 10)
                        <div class="col-md-1">
                            <div class="form-group_disciplina">
                                <label class="control-label" for="nte_seacrh">NTE</label>
                                <input value="{{ $carencia->nte }}" name="nte" id="nte" type="text"
                                    class="text-center form-control form-control-sm" readonly>
                            </div>
                        </div>
                    @endif
                    <div class="col-md-2">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->municipio }}" name="municipio" id="municipio" type="text"
                    ...
                    <div class="col-md-5">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->unidade_escolar }}" name="unidade_escolar" id="unidade_escolar"
                    ...
                    <div class="col-md-2">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->cod_ue }}" name="cod_ue" id="cod_ue" type="text"
                                class="form-control form-control-sm" readonly>
                        </div>
                    </div>
                    <div class="col-md-2">
                        @if (Auth::user()->profile === 'cpg_tecnico' || Auth::user()->profile === 'administrador')
                            <div class="form-group_disciplina">
                                ...
                                <select name="tipo_vaga" id="tipo_vaga" class="form-control select2" required>
                                    <option value="{{ $carencia->tipo_vaga }}" selected>{{ $carencia->tipo_vaga }}
                                    </option>
                        ...
                        @elseif (Auth::user()->profile === 'cpm_tecnico')
                            <div class="form-group_disciplina">
                                <label for="cod_ue" class="">Tipo da vaga</label>
                                <input value="{{ $carencia->tipo_vaga }}" type="text"
                                    class="form-control form-control-sm" readonly>
                            </div>
                        @endif
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-2">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->cadastro }}" name="" id="" type="text"
                                class="form-control form-control-sm" readonly>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->servidor }}" name="" id="" type="text"
                                class="form-control form-control-sm" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->vinculo }}" name="" id="" type="text"
                                class="form-control form-control-sm" readonly>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->regime }}" name="" id="" type="text"
                                class="form-control form-control-sm" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    @if ($carencia->tipo_vaga === 'Profissionalizante')
                        <div class="col-md-4 " id="curso_row">
                            <div class="form-group_disciplina">
                                <label class="control-label" for="curso">Curso <span
                        ...
                        <div class="col-md-3 " id="eixo_row">
                            <div class="form-group_disciplina">
                                <label for="unidade_escolar" class="">Eixo <span
                                        class="span_required">*</span></label>
                                <input value="{{ $carencia->eixo }}" name="eixo" required id="eixo"
                    ...
                    <div class="col-md-2">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->inicio_vaga }}" name="inicio_vaga" id="inicio_vaga"
                                type="date" class="form-control form-control-sm"
                                @if (Auth::user()->profile === 'cpm_tecnico') readonly @endif>
                        </div>
                    </div>
                    @if ($carencia->tipo_carencia === 'Temp')
                        <div class="col-md-2">
                            @if (Auth::user()->profile === 'cpg_tecnico' || Auth::user()->profile === 'administrador')
                                <div class="form-group_disciplina">
                                    ...
                                    <input value="{{ $carencia->fim_vaga }}" name="fim_vaga" id="fim_vaga"
                                        type="date" class="form-control form-control-sm"
                                        @if (Auth::user()->profile === 'cpm_tecnico') readonly @endif>
                                </div>
                            @elseif (Auth::user()->profile === 'cpm_tecnico')
                                <div class="form-group_disciplina">
                                    <label for="regime" class="control-label">Fim da vaga</label>
                                    <input value="{{ $carencia->fim_vaga }}" name="" id=""
                                        type="text" class="form-control form-control-sm" readonly>
                                </div>
                            @endif
                        </div>
                    ...
                    @if ($carencia->tipo_carencia === 'Real')
                        <div class="col-md-3">
                            @if (Auth::user()->profile === 'cpg_tecnico' || Auth::user()->profile === 'administrador')
                                <div class="form-group_disciplina">
                                    ...
                                    <select name="motivo_vaga" id="motivo_vaga" class="form-control select2" required>
                                        <option value="{{ $carencia->motivo_vaga }}" selected>
                                            {{ $carencia->motivo_vaga }}
                                        </option>
                            ...
                            @elseif (Auth::user()->profile === 'cpm_tecnico')
                                <div class="form-group_disciplina">
                                    <label for="regime" class="control-label">Motivo da vaga</label>
                                    <input value="{{ $carencia->motivo_vaga }}" name="" id=""
                                        type="text" class="form-control form-control-sm" readonly>
                                </div>
                            @endif
                        </div>
                    ...
                    @if ($carencia->motivo_vaga === 'LICENÇA POR APRAZAMENTO')
                        <div class="col-md-2">
                            <div class="form-group_disciplina">
                                ...
                                <input value="{{ $carencia->num_rim }}" name="num_rim" id="num_rim" type="text"
                                    class="form-control form-control-sm"
                                    @if (Auth::user()->profile === 'cpm_tecnico') @readonly(true) @endif>
                            </div>
                        </div>
                    @endif
                    <div class="col-md-3">
                        @if (Auth::user()->profile === 'cpg_tecnico' || Auth::user()->profile === 'administrador')
                            <div class="form-group_disciplina">
                                ...
                                <select name="disciplina" id="disciplina" class="form-control select2" required>
                                    <option value="{{ $carencia->disciplina }}" selected>{{ $carencia->disciplina }}
                                    </option>
                        ...
                        @elseif (Auth::user()->profile === 'cpm_tecnico')
                            <div class="form-group_disciplina">
                                <label for="regime" class="control-label">Disciplinaa</label>
                                <input value="{{ $carencia->disciplina }}" name="" id="" type="text"
                                    class="form-control form-control-sm" readonly>
                            </div>
                        @endif
                    </div>
                        ...
                        @if (Auth::user()->profile === 'cpg_tecnico' || Auth::user()->profile === 'administrador')
                            <div class="form-group_disciplina">
                                ...
                                <select name="area" id="area" class="form-control select2">
                                    ...
                                    <option value="CIÊNCIAS HUMANAS E SUAS TECNOLOGIAS">CIÊNCIAS HUMANAS E SUAS TECNOLOGIAS
                                    </option>
                                    <option value="MATEMATICA E SUAS TECNOLOGIAS">MATEMATICA E SUAS TECNOLOGIAS</option>
                                    <option value="LINGUAGENS, CODIGOS E SUAS TECNOLOGIAS">LINGUAGENS, CODIGOS E SUAS
                                        TECNOLOGIAS</option>
                                    <option value="CIÊNCIAS DA NATUREZA E SUAS TECNOLOGIAS">CIÊNCIAS DA NATUREZA E SUAS
                                        TECNOLOGIAS</option>
                                </select>
                            </div>
                        @elseif (Auth::user()->profile === 'cpm_tecnico')
                            <div class="form-group_disciplina">
                                <label for="regime" class="control-label">ÁREA</label>
                                <input value="{{ $carencia->area }}" name="" id="" type="text"
                                    class="form-control form-control-sm" readonly>
                            </div>
                        @endif
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-1">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->matutino }}" name="matutino" id="matutino" type="text"
                    ...
                    <div class="col-md-1">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->vespertino }}" name="vespertino" id="vespertino" type="text"
                                class="text-center form-control form-control-sm"
                                @if (Auth::user()->profile === 'cpm_tecnico') @readonly(true) @endif>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->noturno }}" name="noturno" id="noturno" type="text"
                                class="text-center form-control form-control-sm"
                                @if (Auth::user()->profile === 'cpm_tecnico') @readonly(true) @endif>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group_disciplina">
                            ...
                            <input value="{{ $carencia->total }}" name="total" id="total" type="text"
                                class="text-center form-control form-control-sm" readonly>
                        </div>
                    </div>
                </div>
