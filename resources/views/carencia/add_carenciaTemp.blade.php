...
<div class="col-12 grid-margin stretch-card">
    <div class="card shadow rounded">
        <div class="card_title_form">
            <h4 class="card-title">INCLUIR NOVA CARÊNCIA - TEMPORÁRIA ( <span id="type"></span> ) </h4>
        ...
        <h4 id="title_situacao" class="badge d-flex justify-content-between align-items-center" hidden></h4>
        <div class="card-body">
            <form class="forms-sample" id="InsertForm">
                ...
                <input value="Temp" id="tipo_carencia" name="tipo_carencia" type="text" class="form-control form-control-sm" hidden>
                ...
                <div class="form-row">
                    <div class="col-md-2">
                        <div class="position-relative form-inline form-group">
                            ...
                            <button id="btn-cadastro" class="btn_search_carencia btn btn-sm btn-primary" type="button" onclick="addNewCarencia()" disabled required>
                                <i class="ti-search"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="form-row mt-3">
                    ...
                    <div class="col-md-4 hidden" id="disciplina_especial_row">
                        <div class="form-group_disciplina">
                            <label class="control-label" for="disciplina_especial">COMPONENTE ESPECIAL <span class="span_required">*</span></label>
                            <select name="disciplina_especial" id="disciplina_especial" class="form-control select2" required>
                                <option></option>
                    ...
                    <div class="col-md-2" id="num_rim_row" hidden>
                        <div class="form-group_disciplina">
                            <label for="num_rim" class="">Numero do RIM</label>
                            <input value="" id="num_rim" name="num_rim" type="text" class="form-control form-control-sm" maxlength="10" placeholder="00000/0000">
                        </div>
                    </div>
                    <div class="col-md-3 hidden" id="inicio_vaga_row">
                        <div class="form-group_disciplina">
                            <label for="inicio_vaga" class="">Inicio da vaga <span class="span_required">*</span></label>
                            <input value="" id="inicio_vaga" name="inicio_vaga" type="date" class="form-control form-control-sm" onchange="validaData('inicio_vaga')" required>
                        </div>
                    </div>
                    <div class="col-md-2 hidden" id="fim_vaga_row">
                        <div class="form-group_disciplina">
                            <label for="inicio_vaga" class="">Fim da vaga <span class="span_required">*</span></label>
                            <input value="" id="fim_vaga" name="fim_vaga" type="date" class="form-control form-control-sm" min="" onchange="validaData('fim_vaga')" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-2">
                            <div class="position-relative form-inline form-group">
                                ...
                                <input value="" minlength="8" maxlength="11" name="cadastro" id="cadastro" type="number" class="form-control form-control-sm">
                                <button id="cadastro_btn" class="btn_search_carencia btn btn-sm btn-primary" type="button" onclick="searchServidor()" disabled>
                                    <i class="ti-search"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input value="0" id="matutino" name="matutino" type="number" class="text-center form-control form-control-sm" required min="0" max="20">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                <label for="vespertino" class="">VESP</label>
                                <input value="0" id="vespertino" name="vespertino" type="number" class="text-center form-control form-control-sm" required min="0" max="20">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                <label for="noturno" class="">NOT</label>
                                <input value="0" id="noturno" name="noturno" type="number" class="text-center form-control form-control-sm" required min="0" max="20">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
            ...
            <div id="table_form" hidden>
                <div class="mt-4 mb-2 card_title_form_table">
                    <h5 class=" card-title">VAGAS DETALHADAS</h5>
                </div>
