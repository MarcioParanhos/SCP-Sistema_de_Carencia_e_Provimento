    ...
    <div class="card shadow rounded">
        ...
        <div class="card-body">
                ...
                <div class="form-row">
                    <div class=" col-md-2">
                        <div class="display_btn position-relative form-group">
                            <div>
                                ...
                                <input value="{{ $uee->cod_unidade }}" minlength="8" maxlength="9" name="cod_unidade_provimento" id="cod_unidade_provimento" type="number" class="form-control form-control-sm">
                            </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            @if ($uee->nte < 9)<input value="0{{ $uee->nte }}" id="" name="" type="text" class="form-control form-control-sm" readonly required>
                                @endif
                                @if ($uee->nte > 9)
                                <input value="{{ $uee->nte }}" id="" name="" type="text" class="form-control form-control-sm" readonly required>
                                @endif
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <table id="table1" class=" mb-4 table table-bordered table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="remove_hidden" hidden><input id="validation_mat" id="prover_mat" value="0" name="provimento_matutino" class="input_provimento form-control form-control-sm" type="number" min="0" max="{{ $carencia->matutino }}"></td>
                                <td class="text-center">{{ $carencia->vespertino }}</td>
                                <td class="remove_hidden" hidden><input id="validation_vesp" value="0" name="provimento_vespertino" class="input_provimento form-control form-control-sm " type="number" min="0" max="{{ $carencia->vespertino }}"></td>
                                <td class="text-center">{{ $carencia->noturno }}</td>
                                <td class="remove_hidden" hidden><input id="validation_not" value="0" name="provimento_noturno" class="input_provimento form-control form-control-sm" type="number" min="0" max="{{ $carencia->noturno }}"></td>
            ...
            <form class="forms-sample" id="InsertForm" action="/addNewProvimento" method="post">
                ...
                <input value="{{ Auth::user()->profile }}" id="profile" name="profile" type="text" class="form-control form-control-sm" hidden>
                ...
                <div id="">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2" id="">
                            <div class="form-group_disciplina">
                                <label class="control-label" for="situacao_provimento">situação do provimento</label>
                                <input type="text" value="provida" name="situacao_provimento" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        @endif
                        @if (Auth::user()->profile != "cpg_tecnico")
                        ...
                        <div id="data_assuncao_row" class="col-md-2">
                            <div class="form-group_disciplina">
                                <label for="data_assuncao" class="">assunção</label>
                                <input value="data_assuncao" name="data_assuncao" id="data_assuncao" type="date" class="form-control form-control-sm" required>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div id="buttons" class="buttons mb-4">
                            ...
                            <!-- <button id="btn_submit_provimento" type="submit">
                        ...
                        <!-- @if ( $uee->situacao === "PENDENTE")
                        <div id="buttons" class="buttons mb-4">
                            <button id="btn_submit_provimentos" type="submit" class="btn btn-primary mr-2" disabled><i class="ti-plus"></i> INCLUIR PROVIMENTO</button>
                        </div>
                        @endif -->
                    </div>
                ...
                <table class="table table-sm table-hover mb-2 table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endif
                            @if ($provimento->data_assuncao)
                            <td class="text-center">{{ \Carbon\Carbon::parse($provimento->data_assuncao)->format('d/m/Y') }}</td>
                            @endif
                        </tr>
                        @empty
                        <tr>
...
<!-- <script>
    const inputDate = document.getElementById("data_encaminhamento");
    // Define a data mínima como o primeiro dia do ano atual
    const currentYear = new Date().getFullYear();
    const currentYearStartDate = new Date(currentYear, 0, 1);
    inputDate.min = currentYearStartDate.toISOString().slice(0, 10); // Formato YYYY-MM-DD
</script> -->
<script>
