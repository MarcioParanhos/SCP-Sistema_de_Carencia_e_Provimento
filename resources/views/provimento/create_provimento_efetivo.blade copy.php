            ...
            <form class="forms-sample" action="/provimento/efetivo/create" method="post">
                ...
                <div id="servidor_row">
                    <div class="form-row">
                        <div class=" col-md-2">
                            <div class="display_btn position-relative form-group">
                                <div>
                                    ...
                                    <input value="" minlength="8" maxlength="11" name="" id="cpf_cervidor" type="text" class="form-control form-control-sm">
                                </div>
                                <div class="btn_carencia_seacrh">
                                    <button id="cadastro_btn" class="position-relative btn_search_carencia btn btn-sm btn-primary" type="button">
                                        <i class="ti-search"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="" id="servidor_efetivo" name="servidor_efetivo" type="text" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="num_inscricao_efetivo" class="">Nº Inscrição</label>
                                <input value="" id="num_inscricao_efetivo" name="num_inscricao_efetivo" type="text" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                <label for="servidor_id_efetivo" class="">ID</label>
                                <input value="" id="servidor_id_efetivo" name="servidor_id_efetivo" type="text" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                    ...
                    <div id="hidden_select_unidade_escolar" hidden>
                        ...
                        <br>
                        {{-- Inclusão de servidor subistituido: --}}
                        <div class="form-row">
                            <div class=" col-md-2">
                                <div class="display_btn position-relative form-group">
                                    <div>
                ...
                if (container) {
                    ...
                    if (btn) {
                        btn.addEventListener('click', function () {
                            ...
                            if (!cpf) {
                                Swal.fire({ icon: 'info', title: 'Atenção', text: 'Informe ao menos alguns dígitos do CPF.' });
                                return;
                            }
                            ...
                            fetch('/ingresso/search-cpf', {
                                ...
                                if (json && json.success && json.candidate) {
                                    document.getElementById('nte_efetivo').value = json.candidate.nte || '';
                                    document.getElementById('servidor_efetivo').value = json.candidate.name || '';
                                    document.getElementById('num_inscricao_efetivo').value = json.candidate.num_inscricao || '';
                                    ...
                                    Swal.fire({ icon: 'info', title: 'Não encontrado', text: 'Nenhum candidato encontrado com esse CPF.' });
                                }
                            }).catch(function () {
