...
<div class="form_content mb-0">
    <div class="mb-2 d-flex justify-content-end " style="gap: 3px;">
        ...
        <a class="mb-2 btn bg-primary text-white" target="_blank" href="{{ route('provimentos.relatorio') }}" data-toggle="tooltip" data-placement="top" title="Imprimir">
        ...
        <a class="mb-2 btn bg-primary text-white" target="_blank" href="{{ route('provimentos.excel') }}" data-toggle="tooltip" data-placement="top" title="Download em Excel">
    ...
    <form id="active_form" class="border shadow bg-light rounded p-3" action="{{ route('provimentos.showByForm') }}" method="post" hidden>
        @csrf
        <div class="form-row">
            <div class="col-md-1">
        ...
        <div class="form-row">
            ...
            <div class="col-md-3">
                <div class="form-group_disciplina">
                    ...
                    <select name="search_situacao_provimento" id="search_situacao_provimento" class="form-control form-control-sm select2">
                        <option></option>
        ...
        <div class="form-row mb-4">
            ...
            <div class="col-md-2">
                <div class="form-group_disciplina">
                    ...
                    <select name="search_tipo_movimentacao" id="search_tipo_movimentacao" class="form-control form-control-sm select2">
                        <option></option>
            ...
            <div class="col-md-2">
                <div class="form-group_disciplina">
                    ...
                    <select name="search_servidor_matricula" id="search_servidor_matricula" class="form-control form-control-sm select2">
                        <option></option>
...
<div class="table-responsive">
    <table id="consultarCarencias" class="table table-sm table-hover table-bordered">
        <caption class="mt-2">Vagas Supridas</caption>
            ...
            <tr>
                @if ( $provimento -> nte < 10) <td class="text-center" scope="row">0{{ $provimento -> nte }}</td>
                    ...
                    <td class="text-center" style="vertical-align: middle;">
                        <div class="d-flex">
                            <a href="/provimento/detalhes_provimento/{{ $provimento->id }}"><button id="" class=" btn btn-primary">
                            ...
                            @if (($provimento->situacao === "BLOQUEADO") || ($provimento->pch === 'OK') && ($provimento->situacao_provimento === 'provida') )
                            <a title="Excluir" id="" onclick="event.preventDefault()" class="text-white ml-1 btn-show-carência btn btn-sm btn-muted" disabled hidden></a>
                            @elseif (($provimento->situacao === "DESBLOQUEADO") && ($provimento->pch === 'PENDENTE') || (Auth::user()->profile === "administrador"))
                            <a id="" onclick="destroyProvimento('{{ $provimento -> id }}')" class="ml-1 btn btn-danger">
                            ...
                            @endif
                            @else ($provimento->total < 0) <a title="Excluir" id="" onclick="destroyProvimento('{{ $provimento -> id }}')" class="ml-1 btn-show-carência btn btn-sm btn-danger">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-trash">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M4 7l16 0" />
                                    <path d="M10 11l0 6" />
            ...
            <div class="modal-body justify-content-start p-4">
                <div class="">
                    ...
                    <div class="pt-2">
                        ...
                        <div class="mt-3">
                            <span class="bg-success tipo_carencia"><i class="ti-check"></i></span> - Programado
                        </div>
                    </div>
