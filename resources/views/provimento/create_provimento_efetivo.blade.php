...
@section('content')
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card shadow rounded">
            <div class="shadow bg-primary text-white card_title">
                <h4 class="title_show_carencias">ENCAMINHAMENTO DE SERVIDOR</h4>
                <div class="print-none  d-flex justify-content-center align-items-center">
                    <a data-toggle="modal" data-target="#ExemploModalCentralizado55" title="INCLUIR NOVO SERVIDOR"
                        class="m-1 btn bg-white text-primary" href="">
            ...
            <div class="card-body">
                <form class="forms-sample" action="/encaminhamento/efetivo/create" method="post">
                    @csrf
                    <input value="{{ Auth::user()->id }}" id="usuario" name="usuario" type="text"
                    ...
                    <div id="servidor_row">
                        <div class="form-row">
                            <div class=" col-md-2">
                                <div class="display_btn position-relative form-group">
                                    <div>
                                        ...
                                        <input value="" minlength="8" maxlength="11" name="" id="cpf_cervidor"
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input value="" id="nte_efetivo" name="nte_efetivo" type="text"
                                        class="form-control form-control-sm" readonly>
                                    <input value="" id="servidor_id" name="servidor_id" type="number"
                                        class="form-control form-control-sm" hidden>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input value="" id="servidor_efetivo" name="servidor_efetivo" type="text"
                                        class="form-control form-control-sm" readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="num_inscricao_efetivo" class="">Nº Inscrição</label>
                                    <input value="" id="num_inscricao_efetivo" name="num_inscricao_efetivo"
                                        type="text" class="form-control form-control-sm" readonly>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label for="servidor_id_efetivo" class="">ID</label>
                                    <input value="" id="servidor_id_efetivo" name="servidor_id_efetivo"
                                        type="text" class="form-control form-control-sm" readonly>
                                </div>
                            </div>
                        ...
                        <div class="d-flex">
                            <div id="buttons" class="buttons">
                                <button style="padding: 6px !important; border-radius: 5px !important"
                                    id="encaminhamento_btn" type="button"
                                    class="btn btn-sm btn-primary p-auto subheader">ENCAMINHAR
                        ...
                        <div id="hidden_select_unidade_escolar" hidden>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class=" form-group_disciplina">
                                        <label for="cod_ue" class="">BUSQUE A UNIDADE ESCOLAR <span
                            ...
                            <div class="form-row">
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input value="" id="nte" name="" type="text"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="" id="municipio" name="" type="text"
                                            class="form-control form-control-sm" readonly required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input value="" id="cod_unidade" name="" type="text"
                                            class="form-control form-control-sm" readonly required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <input value="" name="" required id="unidade_escolar"
                            ...
                            <button class="btn btn-primary mb-4" type="button" data-toggle="collapse"
                                data-target="#substituicaoRedaCollapse" aria-expanded="false"
                                aria-controls="substituicaoRedaCollapse">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="collapse" id="substituicaoRedaCollapse">
                                <div class="form-row">
                                    <div class=" col-md-2">
                                        <div class="display_btn position-relative form-group">
                                            <div>
                                            ...
                                            <div class="btn_carencia_seacrh">
                                                ...
                                                <button title="SEGUNDO SERVIDOR" id="cadastro_segundo_servidor_btn"
                                                    class="ml-2 position-relative btn_search_carencia btn btn-sm btn-primary"
                                                    type="button">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="" id="servidor" name="servidor" type="text"
                                                class="form-control form-control-sm" readonly>
                                            <input value="" id="servidor_subistituido" name="servidor_subistituido"
                                ...
                                <div id="disciplinas-substituicao" class="form-row mt-3">
                                    <div class="col-md-12">
                                            ...
                                            <div class="form-row disciplina-row">
                                                <div class="col-md-6">
                                                    <div class="form-group_disciplina">
                                                        ...
                                                        <select name="disciplinas[]" class="form-control form-control-sm discipline-select">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary mt-2" onclick="adicionarDisciplina()">Adicionar Disciplina</button>
                                    </div>
                                </div>
                                ...
                                <div id="segundo_servidor" class="form-row" hidden>
                                    <div class=" col-md-2">
                                        <div class="display_btn position-relative form-group">
                                            <div>
                                                <label for="cadastro_segundo_servidor" class="">Matrícula 2º
                                                    SERVIDOR</label>
                                                <input value="" minlength="8" maxlength="11" name=""
                                                    id="cadastro_segundo_servidor" type="number"
                                                    class="form-control form-control-sm">
                                            </div>
                                            <div class="btn_carencia_seacrh">
                                                <button id="cadastro_btn"
                                                    class="position-relative btn_search_carencia btn btn-sm btn-primary"
                                                    type="button" onclick="searchSegundoServidor()">
                                                    <i class="ti-search"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="segundo_servidor_name" class="">Nome do segundo servidor
                                                subistituido</label>
                                            <input value="" id="segundo_servidor_name" name=""
                                                type="text" class="form-control form-control-sm" readonly>
                                            <input value="" id="id_segundo_servidor_subistituido"
                                                name="id_segundo_servidor_subistituido" type="number"
                                                class="form-control form-control-sm" hidden readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="vinculo_segundo_servidor" class="">Vinculo do segundo
                                                servidor</label>
                                            <input value="" id="vinculo_segundo_servidor" name=""
                                                type="text" class="form-control form-control-sm" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="position-relative form-group">
                                            ...
                                            <input value="" name="" required id="regime_segundo_servidor"
                                                type="text" class="form-control form-control-sm" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!-- data_encaminhamento moved below collapses -->

                            <!-- Tipo de vaga agora selecionado dentro do collapse de Substituição (abaixo) -->
                        </div>
                        ...
                        <div id="hidden_select_unidade_escolar_vaga_real" hidden>
                            ...
                            <div class="form-row">
                                <div class=" col-md-2">
                                    <div class="display_btn position-relative form-group">
                                        <div>
                                            <label for="cod_ue" class="">Codigo da UEE <span
                                                    class="span_required">*</span></label>
                                            <input value="" minlength="8" maxlength="9" name=""
                                                id="cod_ue_provimento" type="number"
                                                class="form-control form-control-sm">
                                        </div>
                                        <div class="btn_carencia_seacrh">
                                            <button id="btn-cadastro"
                                                class="position-relative btn_search_carencia btn btn-sm btn-primary"
                                                type="button" onclick="buscarUeeParaVagaReal()">
                                                <i class="ti-search"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label for="nte" class="">NTE</label>
                                        <input value="" id="nte_provimento_vaga_real" name=""
                                            type="text" class="form-control form-control-sm" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="municipio" class="">Município</label>
                                        <input value="" id="municipio_provimento_vaga_real" name=""
                                            type="text" class="form-control form-control-sm" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <input value="" name="" required
                                            id="unidade_escolar_provimento_vaga_real" type="text"
                                            class="form-control form-control-sm" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div id="data_encaminhamento_row" class="col-md-2">
                                    <div class="form-group_disciplina">
                                        ...
                                        <input value="data_encaminhamento" name="" id="data_encaminhamento"
                                ...
                                <div id="data_assuncao_row" class="col-md-2">
                                    <div class="form-group_disciplina">
                                        ...
                                        <input value="data_assuncao" name="" id="data_assuncao" type="date"
                                            class="form-control form-control-sm">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div id="" class="col-md-2">
                                        <div class="form-group_disciplina">
                                            <label for="data_assuncao" class="">assunção</label>
                                            <input value="data_assuncao" name="" id="data_assuncao"
                                                type="date" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="buttons" class="buttons d-flex" style="position: relative;">
                        <button id="btn_submit" type="submit" class="btn btn-primary mr-2" data-toggle="tooltip"
                            data-placement="top" title="Cadastrar novo encaminhamento" hidden>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
    ...
    <!-- Modal -->
    <div class="modal fade" id="ExemploModalCentralizado55" tabindex="-1" role="dialog"
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group_disciplina">
                                    ...
                                    <input value="" name="nome" id="nome" type="text"
                        ...
                        <div class="form-row mb-2">
                            <div class="col-md-5">
                                <div class="form-group_disciplina">
                                    ...
                                    <input value="" name="cpf" id="cpf" type="text"
    ...
    @php
        ...
        if (isset($disciplinas) && count($disciplinas)) {
            foreach ($disciplinas as $d) {
                $__discOptions[] = ['id' => $d->id, 'text' => $d->nome];
            }
        }
    @endphp
    <script>
        window.disciplinesOptions = {!! json_encode($__discOptions) !!};
    </script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $(document).ready(function() {
                $('#cod_ue').select2({
                    ...
                    width: '100%'
                }); // Garante que o Select2 está inicializado
                // Initialize discipline select(s) if present (fix dropdown positioning)
                try {
            ...
            // Attach search handler for CPF (partial match) using ingresso_candidatos
            try {
                const cpfInput = document.getElementById('cpf_cervidor');
                if (cpfInput) {
                    // find the search button within the same display_btn container
                    const container = cpfInput.closest('.display_btn');
                    if (container) {
                        const btn = container.querySelector('button.position-relative');
                        if (btn) {
                            btn.addEventListener('click', function() {
                                const raw = (cpfInput.value || '').toString();
                                const cpf = raw.replace(/\D/g, '').trim();
                                if (!cpf) {
                                    Swal.fire({
                                        icon: 'info',
                                        title: 'Atenção',
                                        text: 'Informe ao menos alguns dígitos do CPF.'
                                    });
                                    return;
                                }
                                ...
                                fetch('/ingresso/search-cpf', {
                                    ...
                                    if (json && json.success && json.candidate) {
                                        document.getElementById('nte_efetivo').value = json
                                            .candidate.nte || '';
                                        document.getElementById('servidor_efetivo').value = json
                                            .candidate.name || '';
                                        document.getElementById('num_inscricao_efetivo').value =
                                            json.candidate.num_inscricao || '';
                                        var sid = document.getElementById('servidor_id');
                                        if (sid) sid.value = json.candidate.id || '';
                                        var sidVis = document.getElementById('servidor_id_efetivo');
                                        if (sidVis) sidVis.value = json.candidate.id || '';
                                    } else {
                                        Swal.fire({
                                            icon: 'info',
                                            title: 'Não encontrado',
                                            text: 'Nenhum candidato encontrado com esse CPF.'
                                        });
                                    }
                                }).catch(function() {
                                    Swal.fire({
            ...
            // Ensure only one of the two collapses is open at a time
            try {
                function clearCollapseFields(sel) {
                    var container = $(sel);
                    container.find('input').not(':button,:submit,:reset,:hidden').val('');
                ...
                $('#substituicaoRedaCollapse').on('show.bs.collapse', function() {
                    // hide and clear carencia fields
                    $('#carenciaCollapse').collapse('hide');
                    clearCollapseFields('#carenciaCollapse');
                });

                $('#carenciaCollapse').on('show.bs.collapse', function() {
                    // hide and clear substituicao fields
                    $('#substituicaoRedaCollapse').collapse('hide');
                    clearCollapseFields('#substituicaoRedaCollapse');
                });
                
                // Toggle cadastro required depending on tipo_vaga_select
                function updateCadastroRequiredFromSelect() {
                    var select = document.getElementById('tipo_vaga_select');
                    var cadastro = document.getElementById('cadastro');
                    if (!select || !cadastro) return;
                    cadastro.required = (select.value === 'substituicao');
                }

                // initialize and bind
                try {
                    updateCadastroRequiredFromSelect();
                    var tipoSel = document.getElementById('tipo_vaga_select');
                    if (tipoSel) tipoSel.addEventListener('change', updateCadastroRequiredFromSelect);
                } catch (e) {}
            } catch (e) {
                /* ignore if jQuery/Bootstrap not available yet */ }
        });
    </Script>
